    ...
    for split in ['train', 'eval', 'test']:
        for language in language_set:
            for category in category_set:
                ...
                with open(os.path.join(marc_root_dir, split, language, category, f'{split}.tsv'), encoding="utf8") as f:
                ...
                with open(os.path.join(marc_root_dir, split, language, category, f'{split}.jsonl'), 'w') as f:
                    for example in data:
                        json.dump(example, f)
                        f.write('\n')
